...
func (c *authClient) Register(ctx context.Context, in *RegisterRequset, opts ...grpc.CallOption) (*RegisterResponse, error) {
...
func (UnimplementedAuthServer) Register(context.Context, *RegisterRequset) (*RegisterResponse, error) {
...
func _Auth_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Register(ctx, req.(*RegisterRequset))
	}
